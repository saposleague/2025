document.addEventListener("DOMContentLoaded", () => {
  ...
  const sunSVG = `
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#fbff0a" viewBox="0 0 256 256">
  ...
  const atualizarIcone = () => {
    toggleBtn.innerHTML = body.classList.contains("dark-mode") ? sunSVG : moonSVG;
  };
